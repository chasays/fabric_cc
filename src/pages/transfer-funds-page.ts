...
export class TransferFundsPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.confirmationMessage = page.locator('#rightPanel .title:has-text("Transfer Complete!")');
  }

  async transferFunds(amount: number, fromAccountId: string, toAccountId: string): Promise<void> {
    await this.fillElement(this.amountInput, amount.toString(), 'Transfer Amount');
    await this.selectOption(this.fromAccountSelect, fromAccountId, 'From Account');
    ...
    await this.verifyText(this.confirmationMessage, 'Transfer Complete!', 'Transfer confirmation');
  }
} 